...
export default function InvoiceDetailsPage({ params }) {
    ...
    return (
      <Layout>
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-xl text-gray-400">טוען חשבונית...</div>
        </div>
      </Layout>
    )
  }
  ...
  if (!invoice) {
    return (
      <Layout>
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-xl text-gray-400">חשבונית לא נמצאה</div>
        </div>
      </Layout>
    )
  }
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400 mt-1">
                נוצרה ב-{new Date(invoice.created_at).toLocaleDateString('he-IL')}
              </p>
            </div>
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="col-span-2 space-y-6">
            ...
            <div className="bg-gray-800/50 rounded-xl border border-gray-700 p-6">
              <h2 className="text-xl font-bold text-white mb-4">פרטי החשבונית</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="text-white font-semibold">
                    ...
                    {invoice.invoice_type === 'credit' && 'חשבונית זיכוי'}
                  </div>
                </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-white font-semibold">
                      {invoice.customers?.name || 'לא צוין'}
                    </div>
                  </div>
                </div>
                ...
                {invoice.customers?.email && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-white">{invoice.customers.email}</div>
                    </div>
                  </div>
                )}
                ...
                {invoice.customers?.phone && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-white">{invoice.customers.phone}</div>
                    </div>
                  </div>
                )}
              </div>
            ...
            <div className="bg-gray-800/50 rounded-xl border border-gray-700 overflow-hidden">
              ...
              <div className="bg-gray-800 p-6 space-y-2">
                <div className="flex justify-between text-gray-300">
                  ...
                  <span>₪{parseFloat(invoice.subtotal).toLocaleString('he-IL')}</span>
                </div>
                <div className="flex justify-between text-gray-300">
                  <span>מע"מ:</span>
                  <span>₪{parseFloat(invoice.vat_amount).toLocaleString('he-IL')}</span>
                </div>
                <div className="flex justify-between text-xl font-bold text-white pt-2 border-t border-gray-700">
                  <span>סה"כ לתשלום:</span>
                  <span>₪{parseFloat(invoice.total_amount).toLocaleString('he-IL')}</span>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-800/50 rounded-xl border border-gray-700 p-6">
              ...
              <div className="space-y-3">
                <div>
                  <div className="text-sm text-gray-400 mb-2">סטטוס חשבונית</div>
                  <span
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white">
                      {invoice.payment_status === 'paid' && 'שולם במלואו'}
                      {invoice.payment_status === 'partially_paid' && 'שולם חלקית'}
                      {invoice.payment_status === 'unpaid' && 'לא שולם'}
                    </span>
                  </div>
                </div>
                ...
                {invoice.sync_status && (
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-white">
                        {invoice.sync_status === 'synced' && 'מסונכרן'}
                        {invoice.sync_status === 'failed' && 'כשל'}
                        {invoice.sync_status === 'pending' && 'ממתין'}
                      </span>
                    </div>
                  </div>
                )}
              ...
              <div className="space-y-3">
                ...
                {invoice.paid_amount > 0 && (
                  <div className="flex justify-between text-green-300">
                    <span>שולם:</span>
                    <span className="font-bold">
                      ₪{parseFloat(invoice.paid_amount).toLocaleString('he-IL')}
                    </span>
                  </div>
                )}
